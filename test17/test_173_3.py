...
# некоторых отрядов, а также их урон. Есть два отряда, в каждом по 10 монстров. В первом отряде у каждого монстра урон
# абсолютно случайный и колеблется от 50 до 80, а во втором — от 30 до 60. Оба отряда вместе напали на третий,
# также из 10 юнитов. Юнит третьего отряда погибает, если сумма урона от двух монстров больше 100.
#
...
squad_3_conditions = [('Погиб' if squad_1[i_damage] + squad_2[i_damage] > 100 else 'Выжил') for i_damage in range(10)]

print('\nУрон первого отряда:', squad_1)
print('\nУрон второго отряда:', squad_2)
print('\nСостояние третьего отряда:', squad_3_conditions)
